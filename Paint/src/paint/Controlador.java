...
public class Controlador {
    ...
    public void generateSvgCode(String nombre){
        ...
        for (Object figura : figuras) {
            if (figura instanceof Recta recta) {
                svgString += recta.svgLine();
                System.out.println(recta.insertLine(this.pm.idDibujo));
            }
            if (figura instanceof Circunferencia circunferencia) {
                svgString += circunferencia.svgLine();
                System.out.println(circunferencia.insertCircle(this.pm.idDibujo));
            }
            if (figura instanceof Poligono poligono) {
                svgString += poligono.svgLine();
                System.out.println(poligono.insertPolygon(this.pm.idDibujo,this.obtenerIdPoligono()));
            }
        }
        svgString += "</svg>";
        System.out.println(svgString);*/
        this.pm.obtenerFiguras(nombre);
    }
